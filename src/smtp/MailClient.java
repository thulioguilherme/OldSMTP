...
public class MailClient extends Frame {
    ...
    private final Button btSend = new Button("Send");
    private final Button btClear = new Button("Clear");
    private final Button btQuit = new Button("Quit");
    private final Label serverLabel = new Label("Local mailserver:");
    private final TextField serverField = new TextField("", 40);
    private final Label fromLabel = new Label("From:");
    private final TextField fromField = new TextField("", 40);
    private final Label toLabel = new Label("To:"); 
    private final TextField toField = new TextField("", 40);
    private final Label subjectLabel = new Label("Subject:");
    private final TextField subjectField = new TextField("", 40);
    private final Label messageLabel = new Label("Message:");
    private final TextArea messageText = new TextArea(10, 40);
	...
	buttonPanel.add(btQuit);
        ...
        fromField.setText("thulio@cc.ci.ufpb.br");
        toField.setText("emerson@cc.ci.ufpb.br");
        subjectField.setText("Projeto de Redes de Computadores");
	messageText.setText("Vai dá certo.");
